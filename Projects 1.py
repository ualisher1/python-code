...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        final_outputs = sigmoid(np.dot(final_inputs, self.weights_hidden_to_output)) # signals from final output layer
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        self.weights_hidden_to_output += self.learnrate * delta_weights_h_o / n_records # update hidden-to-output weights with gradient descent step
        self.weights_input_to_hidden += self.learnrate * delta_weights_i_h / n_records # update input-to-hidden weights with gradient descent step
